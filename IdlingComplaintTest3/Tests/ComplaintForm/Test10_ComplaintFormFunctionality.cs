...
namespace IdlingComplaints.Tests.ComplaintForm
{
    internal class Test10_ComplaintFormFunctionality : ComplaintFormModel
    {
        ...
        [Test]
        public void NextPageForm_InFrontOf_NoSchool_NoSummonAffidavit_YesAffidavitForm()
        {
        //    ClickNoButton();
        //    Driver.WaitUntilElementFound(By.CssSelector("input[formcontrolname='idc_associatedlastname']"), 20);
        //
        ...
        //    ScrollToZipCode();
        //
        //    Associated_CompanyNameInput = RegistrationUtilities.RetriveRecordValue(ASSOCIATED_PERSON_RECORD_PATH, 1, 0);
        //    
        //    Associated_SelectState(1);
        //    Associated_HouseNumberInput = RegistrationUtilities.RetriveRecordValue(ASSOCIATED_PERSON_RECORD_PATH, 1, 1);
        //    Associated_StreetNameInput = RegistrationUtilities.RetriveRecordValue(ASSOCIATED_PERSON_RECORD_PATH, 1, 2);
        //    Associated_AptFloorInput = RegistrationUtilities.RetriveRecordValue(ASSOCIATED_PERSON_RECORD_PATH, 1, 3);
        //    Associated_CityInput = RegistrationUtilities.RetriveRecordValue(ASSOCIATED_PERSON_RECORD_PATH, 1, 4);
        //    Associated_ZipInput = RegistrationUtilities.RetriveRecordValue(ASSOCIATED_PERSON_RECORD_PATH, 1, 5);
